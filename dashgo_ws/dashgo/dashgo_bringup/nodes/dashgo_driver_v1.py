...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        # Define parameters of Sonar Sensors - ping - dis - angle - speed - dir
        self.disRight = 500
        self.disLeft = 500
        self.disCenter = 500
        self.disBack = 500
        ...
        self.normalDis = 50
        self.farDis = 80
        # Rotation Angle - rad/s
        self.normalLeft = -0.1
        self.strongLeft = -0.2
        self.zeroCenter = 0.0
        self.normalRight = 0.1
        self. strongRight = 0.2
        #Speed -  Direction - m/s
        self.slowForward = 0.1
        self.normalForward = 0.2
        self.zeroSpeed = 0.0
        self.slowBack = -0.1
        self.normalBack = -0.2
        #Current speed
        self.normalSpeed = 0.2
        self.slowSpeed = 0.0
    ...
    def poll(self):
        ...
        if now > self.t_next:
            try:
                r1,r2,r3,r4 = self.arduino.ping() # r1-left, r3-center, r2-right, r4-back
    ...
    def cmdVelCallback(self, req):
        ...
        #===disRight-normalSpeed===#


        if (self.disRight <= self.closeDis) and (x > self.normalSpeed): x = 0.1; th = self.strongLeft;
        elif (self.disRight <= self.normalDis) and (x > self.normalSpeed): x = 0.1; th = self.normalLeft;
        elif (self.disRight <= self.farDis) and (x > self.normalSpeed): x = 0.1; th = self.zeroCenter;
        #===slowSpeed====#
        elif (self.disRight <= self.closeDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disRight <= self.normalDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disRight <= self.farDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;

        #===disLeft-normalSpeed===#
        elif (self.disLeft <= self.closeDis) and (x > self.normalSpeed): x = 0.1; th = self.strongRight;
        elif (self.disLeft <= self.normalDis) and (x > self.normalSpeed): x = 0.1; th = self.normalRight;
        elif (self.disLeft <= self.farDis) and (x > self.normalSpeed): x = 0.1; th = self.zeroCenter;
        #===slowSpeed====#
        elif (self.disLeft <= self.closeDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disLeft <= self.normalDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disLeft <= self.farDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;

        #===disCenter-normalSpeed===#
        elif (self.disCenter <= self.closeDis) and (x > self.normalSpeed): x = 0.1; th = self.zeroCenter;
        elif (self.disCenter <= self.normalDis) and (x > self.normalSpeed): x = 0.1; th = self.zeroCenter;
        elif (self.disCenter <= self.farDis) and (x > self.normalSpeed): x = 0.1; th = self.zeroCenter;
        #===slowSpeed====#
        elif (self.disCenter <= self.closeDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disCenter <= self.normalDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;
        elif (self.disCenter <= self.farDis) and (x > self.slowSpeed): x = 0.05; th = self.zeroCenter;

        #===disBack-normalBack===#
        elif (self.disBack <= self.closeDis) and (x<0): x = 0; th = self.zeroCenter;
        elif (self.disBack <= self.normalDis) and (x<-0.05): x = -0.05; th = self.zeroCenter;
        elif (self.disBack <= self.farDis) and (x<-0.15): x = -0.15; th = self.zeroCenter;
